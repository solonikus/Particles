...
#define CL_COUNT_ADD_PARTICLES 100000
...
public:
    ...
    cl::Kernel k_moving_wa, k_build_sphere, k_init, k_vector_kas;
    cl::BufferGL mem_buf;
    ...
    void Build(bool is_cube, cl_float3);
    void VecQuas(cl_float3 center);
};
